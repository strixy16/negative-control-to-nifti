#!/bin/bash
#SBATCH --job-name=CT_to_nifti_Head-Neck-PET-CT_try_2
...
python3 code/all_CT_RTSTRUCT_to_nifti.py --config_file "/cluster/home/t126036uhn/code/Ct_RTSTRUCT_to_nifti/negative-control-to-nifti/config_Head-Neck-PET-CT.yaml"
